...
{/* searchbar*/}
            <div className='hidden md:flex items-center gap-2 ml-auto'>
              <div className='relative w-full max-w-xs'>
                <input className='border rounded-full p-4 h-7 w-full text-sm outline-none' type="text" name="query" placeholder="Search for products.." required />
          ...
          <>
            <div className='md:hidden bg-blue-100 py-1 space-x-5 flex flex-row justify-center items-center '>
                ...
                <div className='relative '>
                  <input className='border rounded-full p-2 h-7 w-full text-sm outline-none' type="text" name="query" placeholder="Search for products.." required />
                  <Search className='absolute right-2 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-500 cursor-pointer'/>
                </div>
                <NavLink to="/cart" className={navClass}>
                  <div className='flex items-center relative'>
